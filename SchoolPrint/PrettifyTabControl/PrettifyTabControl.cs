...
namespace PControl
{
    public class PrettifyTabControl : TabControl
    {
        #region Fields
        ...
        {
            private PrettifyTabControl _owner;
            private bool _bPainting;

            public UpDownButtonNativeWindow(PrettifyTabControl owner)
                : base()
            {
                _owner = owner;
